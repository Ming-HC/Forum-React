...
class LoginRegister extends Component {
            ...
            <section>
                <div className={`container ${styles.container}`}>
                    ...
                    <div className={styles.imgcontainer}>
                        <img src="https://ejs.mingspace.website/image/member/demo.png" alt="Avatar" />
                    </div>
    ...
    showheadshot = (e) => {
        ...
        if ($('input[type=file]').val() !== "") {
            ...
            img.src = "https://ejs.mingspace.website/image/member/demo.png";
        }
    }
    postheadshot = async () => {
        if ($("input[type=file]")[0].files.length && this.state.url === 'register') {
            ...
            if (uploadheadshotresult.data.indexOf('\\') > -1) {
                $('.imgcontainer img').prop('src', `https://ejs.mingspace.website/image/member/upload/headshot/${uploadheadshotresult.data.split('headshot\\')[1]}`);
            ...
            if (this.state.url === 'login') {
                ...
                if (loginresult.data.account) {
                    if (loginresult.data.headshot) {
                        $('.container img, #membericon img').prop('src', `https://ejs.mingspace.website/image/member/upload/headshot/${loginresult.data.headshot}`);
                    }
                    ...
                    if (document.referrer.indexOf('register') > -1) {
                        if (loginresult.data.logined_times < 1) {
                            ...
                            setTimeout(() => { window.open(`#/member/${loginresult.data.account}/personal`); }, 5000);
                        } else {
