...
class Navigation extends Component {
    state = {
        user: '',
        headshot: "https://ejs.mingspace.website/image/member/demo.png"
    }
    render() {
        return (
    ...
    async componentDidMount() {
        ...
        if (window.location.hash.indexOf('forum') > -1) {
        ...
        if (newState.user.indexOf("login") === -1) {
            ...
            newState.headshot = headshotresult.data ? headshotresult.data.indexOf("headshot") === -1 ? headshotresult.data : `https://ejs.mingspace.website/image/member/upload/headshot/${headshotresult.data}` : "https://ejs.mingspace.website/image/member/demo.png";
        }
        ...
        if ($('#membericon').prop('href').indexOf('login') === -1) {
            ...
            if (window.confirm(hint) === true) {
                ...
                if (logoutresult.data) {
                    var newState = {...this.state};
                    newState.user = '';
                    newState.headshot = "https://ejs.mingspace.website/image/member/demo.png";
